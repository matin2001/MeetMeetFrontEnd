      ...
      <div className={style.plans}>
        ...
        <div className={style.gridForPlan}>
          <div className={style.login_plans}>
            <div class="card-body">
              <h3 class="card-title pt-3" className={style.planHeading}>
                Regular
              </h3>
              <h2
                class="card-title text-primary mb-0 pt-4"
                className={style.PlanPrice}
              >
                $4
              </h2>
              <div
                class="text-muted font-weight-medium mt-2"
                className={style.PlanPerMonth}
              >
                per month
              </div>
              <ul class="list-unstyled" className={style.planAttr}>
